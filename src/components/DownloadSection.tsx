...
const platforms = [
  {
    ...
    url: '/downloads/seelo-desktop.exe',
    icon: (
  ...
  },
  {
    ...
    url: '/downloads/seelo-desktop.dmg',
    icon: (
      <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    url: '/downloads/seelo-desktop.AppImage',
    icon: (
      <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    url: '/downloads/seelo-mobile.apk',
    icon: (
      <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
...
const pluginItems = [
  {
    ...
    url: '/downloads/seelo-figma-plugin.zip',
  ...
  },
  {
    ...
    url: '/downloads/seelo-relay-server.zip',
