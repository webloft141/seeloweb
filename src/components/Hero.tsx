export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-base-50 transition-colors">
      <div className="glow -top-40 -right-40 opacity-60" />
      <div className="glow -bottom-40 -left-40 opacity-40" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-28 pb-24">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-base-950 leading-[1.05] tracking-tight mb-8 animate-fade-in-up transition-colors">
          From Figma to
          <br />
        ...
        <p className="text-base md:text-lg text-base-500 max-w-2xl mx-auto mb-12 leading-relaxed animate-fade-in-up transition-colors">
        ...
        <div className="mt-20 flex items-center justify-center gap-10 text-base-400 text-xs animate-fade-in-up transition-colors">
